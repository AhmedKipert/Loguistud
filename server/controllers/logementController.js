...
exports.createLogement = async (req, res) => {
    try {
        ...
        // // Vérication des informations du logement
        // if (!titre || !description || !type || !surface || !prix || !charges ||
        //     !disponible || !ville || !quartier || !proprietaire) 
        // {
        //     console.log('Informations manquants');
